# 🔧 Troubleshooting Guide — GPU Scheduler & K8s Allocator Studio
...
2. **Check official documentation:**
   - [GitHub Issues for this repo](https://github.com/Pradeeptalari14/tp-gpu-scheduler/issues)
   - [Studio FAQ](https://pradeeptalari14.github.io/portfolio/tools/gpu-scheduler/)
